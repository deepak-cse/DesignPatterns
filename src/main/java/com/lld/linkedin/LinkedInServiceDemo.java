...
public class LinkedInServiceDemo {
    public static void main(String[] args) {
        ...
        linkedInService.createJobPosting(jobPosting);

        // Search for users
        List<User> searchResults = linkedInService.searchUser("John");
        ...
        List<JobPosting> jobPostingResults = linkedInService.searchJobPosting("Software");
