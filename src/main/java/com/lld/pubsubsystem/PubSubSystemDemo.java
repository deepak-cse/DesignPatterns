...
public class PubSubSystemDemo {
    ...
    public static void main(String[] args) {
        ...
        // Subscribe to topics
        topic1.addSubsciber(subscriber1);
        topic1.addSubsciber(subscriber2);
        topic2.addSubsciber(subscriber2);
        topic2.addSubsciber(subscriber3);
        ...
        topic1.removeSubsciber(subscriber2);
